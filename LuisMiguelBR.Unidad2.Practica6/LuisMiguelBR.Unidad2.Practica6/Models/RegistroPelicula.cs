...
namespace LuisMiguelBR.Unidad2.Practica6.Models
{
    public class RegistroPelicula
    {
        ...
        {
            Conectar();
            SqlCommand comando = new SqlCommand("Insert Into TBL_PELICULA (Titulo, Director, AutorPrincipal, No_Autores, Duracion, Estreno)" +
        ...
        public List<Pelicula> RecuperarTodo()
        {
            ...
            while (registros.Read())
            {
                Pelicula peli = new Pelicula
                {
                    ...
                    Duracion = double.Parse(registros["Titulo"].ToString()),
